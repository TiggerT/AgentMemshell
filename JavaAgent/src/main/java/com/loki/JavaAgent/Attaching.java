...
public class Attaching {
    public static void main(String[] args) throws Exception {
        ...
        String currentPath = Attaching.class.getProtectionDomain().getCodeSource().getLocation().getPath();
        currentPath = currentPath.substring(0, currentPath.lastIndexOf("/") + 1);
        //System.out.println("path:"+currentPath);
        String agentFile = currentPath.substring(1,currentPath.length())+"JavaAgent-1.0-SNAPSHOT-jar-with-dependencies.jar";
